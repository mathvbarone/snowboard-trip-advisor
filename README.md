...
- **Phase 1** — in progress on `main`. Epics 1–3 (workspace scaffolding + schema migration + public app) shipped; Epic 4 (admin app) is mid-flight: Tiers 1–4 (foundation, navigation, editor, publish workflow) are on `main`; Tier 5 (polish + integration backfill) is pending. Epics 5–6 (real adapters, ops) follow.
