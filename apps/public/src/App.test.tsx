...
// Inline test-time path resolution. Production wiring (Vite static asset import for apps/public)
// lands in Epic 3 PR 3.1; this inline form has no production caller.
//
...
describe('App', (): void => {
  ...
  it('can load the published dataset (smoke; full UI in Epic 3)', async (): Promise<void> => {
