...
describe('App (PR 4.1b §2.4 — Shell composition)', (): void => {
  ...
  it('renders ResortEditor on editor route (PR 4.4b)', (): void => {
    ...
    // Suspense fallback (`role="status"` + "Loading…" — see Decision D4 in
    // docs/superpowers/plans/2026-05-08-epic-4-tier-3-editor-plan.md). Dashboard
    // and ResortsTable subtrees MUST NOT render on the editor route.
