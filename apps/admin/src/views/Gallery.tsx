...
//
// S1c-1 ships the first 4 (Pill/StatusPill/SourceBadge/Skeleton); PR S1c-2
// will ADD Chip/FieldValueRenderer/ExternalLink to this same function and
// `data-gallery-family="S1c-feedback-status"` section without disturbing
// these 4 (one-exemplar-per-component invariant).
